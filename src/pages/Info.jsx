...
const Info = () => {
  ...
  const renderInfos = infosList.map((item, index) => {
        ...
        <div className="info-container">
          ...
          <h2 className="stats-title">Status</h2>
            <div className="stats-attribut">
              ...
              <div className="stats-number">
                <div
                  className="value"
                  style={{ width: `${item?.stats?.[0].base_stat * 4}px` }}
                ></div>
              </div>
            </div>
            <div className="stats-attribut">
              ...
              <div className="stats-number">
                <div
                  className="value"
                  style={{ width: `${item?.stats?.[1].base_stat * 4}px` }}
                ></div>
              </div>
            </div>
            <div className="stats-attribut">
              ...
              <div className="stats-number">
                <div
                  className="value"
                  style={{ width: `${item?.stats?.[2].base_stat * 4}px` }}
                ></div>
              </div>
            </div>
            <div className="stats-attribut">
              ...
              <div className="stats-number">
                <div
                  className="value"
                  style={{ width: `${item?.stats?.[3].base_stat * 4}px` }}
                ></div>
              </div>
            </div>
            <div className="stats-attribut">
              ...
              <div className="stats-number">
                <div
                  className="value"
                  style={{ width: `${item?.stats?.[4].base_stat * 4}px` }}
                ></div>
              </div>
            </div>
            <div className="stats-attribut">
              ...
              <div className="stats-number">
                <div
                  className="value"
                  style={{ width: `${item?.stats?.[5].base_stat * 4}px` }}
                ></div>
              </div>
            </div>
            <Link to="/">
          ...
          <div className="info-image">
            ...
            <div className="details">
              <div>
                Tipos: {item?.types?.[0].type.name} {}
              </div>
              <div>
                Abilidades: {item?.abilities?.[0].ability.name}{" "}
